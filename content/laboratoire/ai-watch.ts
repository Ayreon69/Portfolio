...
const aiWatch: ProjectContent = {
  ...
  donnees: {
    paragraphs: [
      ...
      "Les sources ne sont pas arbitrées au volume mais au rendement, mesuré source par source : Claude Code documentation ressort à 100 % d'éléments jugés utiles, Next.ink à 7 %. Sept sources ont été désactivées sur cette base, soit 26 % du volume collecté pour 5 % de ce qui servait vraiment. Il en reste 23 actives.",
    ],
    stack: [
      "Python",
      "GitHub Actions",
  ...
  result: {
    paragraphs: [
      ...
      "La mesure a produit un effet net : les sept sources coupées pesaient 26 % du volume collecté pour 5 % de ce qui était jugé utile. Retirer un quart du bruit en perdant un vingtième de la valeur. Voilà le résultat, pas le nombre de fiches accumulées.",
    ],
  },
