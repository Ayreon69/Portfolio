...
const commissionBot: ProjectContent = {
  ...
  result: {
    paragraphs: [
      ...
      "Il est déployé et utilisé en interne. Mais aucune métrique d'usage n'existe, et des réponses ont été contestées : la preuve s'arrête là. C'est précisément ce qui range ce projet en case study plutôt qu'en démonstration — et ce que la section suivante creuse.",
    ],
  },
