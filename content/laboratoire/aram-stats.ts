...
const aramStats: ProjectContent = {
  ...
  recul: {
    paragraphs: [
      ...
      "Le snowball, oui. La stratégie autour, non. Le snowball reste le seul mécanisme possible : il n'existe aucune liste de joueurs de ce mode, la seule façon de les énumérer est de les découvrir dans les parties des autres. Ce que je referais autrement tient en un point : le crawl visite chaque joueur exactement une fois, pour toujours, alors que la fenêtre du client ne remonte que vingt parties. Le rendement total est donc plafonné par le nombre de joueurs atteints, pendant que les mêmes 13 087 joueurs continuent de jouer tous les jours. Revisiter un joueur actif chaque semaine transformerait une collecte unique en flux continu. C'est ce qui a manqué quand le nouveau patch est sorti.",
