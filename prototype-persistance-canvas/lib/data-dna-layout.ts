// Positionne les 29 nœuds réels du Data DNA (data/nodes.json, data/edges.json)
// dans l'espace 3D. Layout déterministe : rien n'est aléatoire à chaque rendu,
// seul l'id du nœud sert de graine, pour que la scène soit stable entre deux
// chargements et ne "saute" jamais visuellement.
